...
3. Click *chapter16*. Open **simple_prompt_flow.ipynb** file. 
...
5. Read and follow all the steps of **simple_prompt_flow.ipynb** file. 

### File Name: simple_prompt_flow.ipynb
### Purpose: 
