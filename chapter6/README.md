...
3. Click *chapter6*. Open **simple_rag_building_langchain.ipynb** file. 
...
5. Read and follow all the steps of **simple_rag_building_langchain.ipynb** file. 
...
6. Click *chapter6*. Open **simple_rag_building_llama_index.ipynb** file. 

7. Use *Image* as **Data Science 3.0**. *Kernel* as **Python 3**. *Instance* as **ml.t3.medium**.

![7_lab-JupyterLab_2](../image/7_lab-JupyterLab_2.png)

8. Read and follow all the steps of **simple_rag_building_llama_index.ipynb** file. 
...
9. Click *chapter6*. Open **advanced_rag_building_part1.ipynb** file. 

10. Use *Image* as **Data Science 3.0**. *Kernel* as **Python 3**. *Instance* as **ml.t3.medium**.

![7_lab-JupyterLab_2](../image/7_lab-JupyterLab_2.png)

11. Read and follow all the steps of **advanced_rag_building_part1.ipynb** file. 
...
12. Click *chapter6*. Open **advanced_rag_building_part2.ipynb** file. 

13. Use *Image* as **Data Science 3.0**. *Kernel* as **Python 3**. *Instance* as **ml.t3.medium**.

![7_lab-JupyterLab_2](../image/7_lab-JupyterLab_2.png)

14. Read and follow all the steps of **advanced_rag_building_part2.ipynb** file. 
